...
We use (InSC, InWT, InCR) as responses and (1, In140_AGE) as predictors (1 represents the intercept).
...
We use artificial data to implement data augmentation algorithms in different situations.
